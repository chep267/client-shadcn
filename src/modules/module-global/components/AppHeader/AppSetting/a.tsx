...
/** components */
import { MenubarContent, MenuItemCustom, MenubarRadioGroup, MenubarRadioItem } from '@module-base/components/menubar';
...
export default function AppSetting() {
    ...
    const renderMenuBase = React.useMemo(() => {
        const menuBase: App.ModuleBase.Component.NestedItemProps[] = [
            {
                ...
                subMenu: [
                    ...
                    },
                    {
                        ...
                        icon: <LightModeIcon className="text-warning" />,
        ...
        return menuBase.map((item) => {
            return <MenuItemCustom item={item} />;
        });
    }, [settingAction]);
